...
public class DoctorsSearchScreen extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        // Load FXML layout
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/group3/doctorSearchLayout.fxml"));
        ...
        // Add CSS
        scene.getStylesheets().add(Objects.requireNonNull(getClass().getResource("/com/group3/doctorSearchStyle.css")).toExternalForm());
